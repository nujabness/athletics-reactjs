                ...
                <div className="card">
                    <div className="card-content">
                        ...
                        <div className="content">
                            {
                                this.state.participeDeja ? <button className="button is-danger" onClick={() => this.annulerParticipation()}>Annuler</button>: <button className="button is-info" onClick={() => this.participer()}>Je Participe</button>
                            }
                        </div>
                    </div>
                </div>
