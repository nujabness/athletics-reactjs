...
class EditProfile extends Component {
    ...
    async componentDidMount() {
        ...
        let response2 = await UserService.details({id: this.props.match.params.id});
        if (response2.ok) {
                ...
                <div className="column is-two-thirds">
                    <form onSubmit={(e)=>this.updateUser(e)}>
                        ...
                        <label> Nationalite Athlète
                            <br/>
                            <div className="select">
                                <select id="nationalite_athlete" onChange={(e) => this.handleChange(e)} defaultValue={this.state.user.nationalite_athlete.nom_nationalite} required>
                                    {
